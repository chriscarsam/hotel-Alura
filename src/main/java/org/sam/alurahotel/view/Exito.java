...
public class Exito extends JDialog {
	 ...
	 */
	public Exito() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Exito.class.getResource("/org/sam/alurahotel/imagenes/aH-40px.png")));
		...
		contentPanel.setLayout(null);
		{
			...
			lblNewLabel.setIcon(new ImageIcon(Exito.class.getResource("/org/sam/alurahotel/imagenes/Ha-100px.png")));
